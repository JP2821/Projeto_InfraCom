...
while server_on:
    ...
    while (seq != seq_esperado or soma != checksum): 
        ...
        msg = funcoes.cria_pacote_servidor(server.getsockname()[1], port, comprimento_servidor, 1-seq_esperado, 1-seq_esperado)
    ...
    while True:
        funcoes.print_info_servidor(dado, dados_recebidos, dados_duplicados, dados_corrompidos)        
        msg = funcoes.cria_pacote_servidor(server.getsockname()[1], port, comprimento_servidor, seq_esperado, 0) # ack =0
